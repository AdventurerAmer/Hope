...
void end_one_use_command_buffer(Vulkan_Context *context, Vulkan_Command_Buffer *command_buffer, Upload_Request_Handle upload_request_handle = Resource_Pool<Upload_Request>::invalid_handle);